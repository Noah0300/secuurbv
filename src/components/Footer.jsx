          ...
          <div className="footer-grid">
            ...
            <div className="footer-section footer-about">
              <div className="company-logo-text">
                <img src={`${process.env.PUBLIC_URL}/images/Secuur-Beeldmerk.png`} alt="Secuur BV Logo" className="footer-logo" />
              </div>
              <p>
            ...
            <div className="footer-section footer-partnership">
              ...
              <img src={`${process.env.PUBLIC_URL}/images/METZ-logo-new-wit-600x202-1.png`} alt="Metz Verbouw" className="metz-logo" />
            </div>
          </div>
        </div>
      </div>

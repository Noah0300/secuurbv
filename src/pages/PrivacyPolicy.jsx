    ...
    <section className="section">
      <div className="container">
        ...
        <div className="privacy-content">
          <p>
            <strong>Secuur Brandveiligheid BV </strong>respecteert de privacy van de bezoekers van haar website, in het bijzonder de rechten van bezoekers met betrekking tot de geautomatiseerde verwerking van persoonsgegevens. Vanwege volledige transparantie met onze klanten hebben wij daarom een beleid geformuleerd en geïmplementeerd met betrekking tot deze verwerkingen zelf, het doel ervan alsook de mogelijkheden voor betrokkenen om hun de rechten zo goed mogelijk te kunnen uitoefenen.
          ...
          <ol>
            <li>Website (hierna ook "De website"): <strong>www.secuurbv.nl</strong></li>
            <li>Verantwoordelijke voor de verwerking van persoonsgegevens (Hierna ook: "De beheerder"): <strong>Secuur Brandveiligheid B.V. , Nederland, KVK: 77360672</strong></li>
          </ol>
          ...
          <p>Uw gegevens worden verzameld door <strong>Home Wraps </strong> en (een) externe verwerker(s). Onder persoonsgegevens worden verstaan: alle informatie over een geïdentificeerde of identificeerbare natuurlijke persoon; als identificeerbaar wordt beschouwd een natuurlijke persoon die direct of indirect kan worden geïdentificeerd, met name aan de hand van een identificator zoals een naam, een identificatienummer, locatiegegevens, een online identificator of een of meer elementen die kenmerkend zijn voor de fysieke, fysiologische, genetische, psychische, economische, culturele of sociale identiteit.</p>
          ...
          <p>Op grond van artikel 13 lid 2 sub b AVG heeft eenieder recht op inzage van en rectificatie of wissing van zijn persoonsgegevens of beperking van de hem betreffende verwerking, alsmede het recht tegen de verwerking bezwaar te maken en het recht op gegevensoverdraagbaarheid. U kunt deze rechten uitoefenen door contact met ons op te nemen via <strong>info@secuurbv.nl</strong>.</p>
          ...
          <p>U kunt commerciële aanbiedingen krijgen van de beheerder. Indien u deze niet (meer) wenst te ontvangen, stuurt u een mail naar het volgende adres: <strong>info@secuurbv.nl</strong>.</p>
          ...
          <p>Voor vragen, productinformatie of informatie over de website zelf, kunt u zich richten tot: <strong>info@secuurbv.nl</strong></p>
        </div>
      </div>
    </section>
  );
